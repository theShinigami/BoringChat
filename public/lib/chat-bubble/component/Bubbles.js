...
function Bubbles(container, self, options) {
  ...
  this.typeInput = function(callbackFn) {
    ...
    var inputText = false;
    var inputWrap = false;
    const isInputProvided = document.getElementsByClassName( "input-wrap" ).length > 0;

    if ( isInputProvided ) {

      inputText = document.getElementsByClassName( "input-wrap" )[0];
    ...
    // ( !isInputProvided ) ? container.appendChild(inputWrap) : "false";
    if ( !isInputProvided ) container.appendChild( inputWrap );
